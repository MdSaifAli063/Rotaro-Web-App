...
DROP POLICY IF EXISTS "notifications insert same business recipients" ON public.notifications;

GRANT INSERT ON public.notifications TO authenticated;

CREATE POLICY "notifications insert same business recipients"
